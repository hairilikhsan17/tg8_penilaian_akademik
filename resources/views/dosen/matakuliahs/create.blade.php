...
<head>
    ...
    <title>Tambah Mata Kuliah - SPA Sistem Penilaian Akademik</title>
...
<body class="bg-gradient-to-br from-blue-50 via-white to-purple-50 min-h-screen">
    ...
    <main class="lg:ml-64 pt-20 min-h-screen">
        <div class="p-6">
            ...
            <!-- Page Title -->
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Tambah Mata Kuliah Baru</h2>
                <p class="text-gray-600 text-sm mt-1">Tambahkan mata kuliah baru yang akan Anda ampu</p>
            </div>
