...
<head>
    ...
    <title>Edit Mata Kuliah - SPA Sistem Penilaian Akademik</title>
    ...
    <aside id="sidebar" class="fixed left-0 top-0 h-full w-64 bg-black text-white pt-20 z-40 sidebar-transition transform lg:translate-x-0 -translate-x-full overflow-y-auto">
        ...
        <div class="mx-4 my-6 bg-gray-900 bg-opacity-50 rounded-lg p-4 border border-gray-700">
            <div class="flex items-center space-x-3 mb-3">
                ...
                <div class="flex-1">
                    <p class="text-sm font-bold text-white truncate">Amirawati M.kom</p>
                    <p class="text-xs text-gray-400">NIP-123456</p>
                </div>
            </div>
        ...
        <div class="p-6">
            ...
            <nav class="mb-6">
                <ol class="flex items-center space-x-2 text-sm text-gray-600">
                    ...
                    <li><a href="/dosen/matakuliahs" class="hover:text-blue-600">Mata Kuliah</a></li>
                    <li><span class="text-gray-500">/</span></li>
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 text-sm mt-1">Ubah informasi mata kuliah</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <form method="POST" action="/dosen/matakuliahs/{{ $matakuliah->id }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="md:col-span-2">
                                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                    ...
                                    <p class="text-sm text-gray-700">
                                        ...
                                        <strong id="dosenName">{{ $matakuliah->dosen->nama_user ?? session('nama_user') }}</strong>
                                    </p>
