            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <form method="GET" action="/dosen/nilai-mahasiswa" class="flex flex-col md:flex-row gap-3">
                    ...
                    <select name="status" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <option value="siap">Siap Input Nilai</option>
                        <option value="belum">Belum Ada Komponen</option>
                        <option value="belum_lengkap">Komponen Belum Lengkap</option>
                    </select>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex flex-col space-y-1 text-xs">
                                        ...
                                        <div class="pt-1 border-t border-gray-200 mt-1">
                                            <span class="font-bold text-green-600">Total: 100%</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <a href="/dosen/matakuliahs/1/nilai" 
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-semibold text-gray-900">IF302</span>
                                </td>
                                <td class="px-6 py-4">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900">Algoritma dan Struktur</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-purple-100 text-purple-800">
                                        Semester 3
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex flex-col space-y-1 text-xs">
                                        ...
                                        <div class="flex items-center justify-center space-x-2">
                                            <span class="text-gray-600">UTS:</span>
                                            <span class="font-semibold text-red-600">30%</span>
                                        </div>
                                        <div class="flex items-center justify-center space-x-2">
                                            <span class="text-gray-600">UAS:</span>
