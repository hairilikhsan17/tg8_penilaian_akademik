    ...
    <main class="lg:ml-64 pt-20 min-h-screen">
        <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">
                            Nama: <span class="font-semibold" id="mahasiswaNama">Hairil Ikhsan</span> | 
                            NIM: <span class="font-semibold" id="mahasiswaNim">221118</span>
                        </p>
                    </div>
                ...
                <!-- Info IPK -->
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6" id="infoIPK" style="display: none;">
                    ...
                    <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg p-4 text-white">
                        ...
                        <p class="text-2xl font-bold" id="ipkValue">0.00</p>
                    </div>
                    <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg p-4 text-white">
                        <p class="text-sm text-purple-100 mb-1">Total Mata Kuliah</p>
                        <p class="text-2xl font-bold" id="totalMatakuliah">0</p>
                    </div>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-4 py-3 text-left text-sm text-gray-700">1</td>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-center text-sm text-gray-700">3</td>
                                <td class="px-4 py-3 whitespace-nowrap text-center text-sm text-gray-700">3</td>
                                <td class="px-4 py-3 whitespace-nowrap text-center text-sm text-gray-700">88.50</td>
                                <td class="px-4 py-3 text-center bg-green-50">
                                    <span class="px-2 py-1 rounded text-xs font-semibold bg-green-100 text-green-800">
                                        A
                                    </span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-center text-sm text-gray-700">12.00</td>
                            </tr>
